...
describe("ReservationService", () => {
  ...
  beforeEach(() => {
    ...
    reservationService = new ReservationService(reservationValidator);
  ...
  describe("createReservation", () => {
    it("should create a reservation", async () => {
      ...
      reservationService.reservationRepository.create.mockResolvedValue(
        reservation,
      );
      ...
      expect(
        reservationService.caravanRepository.findById,
      ).toHaveBeenCalledWith("caravan-id");
      expect(reservationService.reservationFactory.create).toHaveBeenCalled();
      expect(
        reservationService.reservationRepository.create,
      ).toHaveBeenCalledWith(reservation);
      expect(
        reservationService.reservationNotifier.notify,
      ).toHaveBeenCalledWith(reservation);
  ...
  describe("getReservationsForUser", () => {
    it("should get reservations for a user", async () => {
      ...
      reservationService.reservationRepository.findByUserId.mockResolvedValue(
        reservations,
      );
      ...
      expect(
        reservationService.reservationRepository.findByUserId,
  ...
  describe("getReservationById", () => {
    it("should get a reservation by id", async () => {
      ...
      reservationService.reservationRepository.findById.mockResolvedValue(
        reservation,
      );
      reservationService.caravanRepository.findById.mockResolvedValue(caravan);
      ...
      ).toHaveBeenCalledWith(reservationId);
      expect(result).toEqual(reservation);
    });
  ...
  describe("updateReservationStatus", () => {
    it("should update a reservation status", async () => {
      ...
      reservationService.caravanRepository.findById.mockResolvedValue(caravan);
      reservationService.reservationRepository.update.mockResolvedValue(
        updatedReservation,
      );
      ...
      expect(
        reservationService.reservationRepository.update,
      ).toHaveBeenCalledWith(reservationId, { $set: { status } });
  ...
  describe("getReservationsForHost", () => {
    it("should get reservations for a host's caravans", async () => {
      ...
      reservationService.caravanRepository.findByHostId.mockResolvedValue(
        caravans,
      );
      reservationService.reservationRepository.findByCaravanIds.mockResolvedValue(
        reservations,
      );
      ...
      expect(
        reservationService.caravanRepository.findByHostId,
      ).toHaveBeenCalledWith(userId);
      expect(
        reservationService.reservationRepository.findByCaravanIds,
      ).toHaveBeenCalledWith(["caravan-id-1", "caravan-id-2"]);
      expect(result).toEqual(reservations);
    });
  });
});
